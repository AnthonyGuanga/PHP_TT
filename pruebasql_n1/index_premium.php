...
<body>
    <header>
        <h1>Bienvenido, <?= htmlspecialchars($_SESSION['user_name']) ?> (Usuario Premium)</h1>
        <nav>
                ...
                <tbody>
                    <?php foreach ($books as $book): ?>
                        <tr>
                            ...
                            <td>
                                <?php if ($book['stock'] > 0): ?>
                                    <form action="buy_book.php" method="post" style="display:inline;">
    ...
    <footer>
        <p>&copy; 2025 Librería Premium</p>
    </footer>
</body>
</html>
